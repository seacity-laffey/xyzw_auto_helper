...
export const taskColumns = [
  ...
  },
  {
    ...
    key: "selectedTokens",
    width: 150,
    render: (row: TaskColumnRow) => `${row.selectedTokens.length} 个`,
  },
  {
    title: "选中任务",
    key: "selectedTasks",
    width: 150,
    render: (row: TaskColumnRow) => `${row.selectedTasks.length} 个`,
  },
  {
    title: "状态",
    key: "enabled",
    width: 80,
    render: (row: TaskColumnRow) => (row.enabled ? "启用" : "禁用"),
  },
